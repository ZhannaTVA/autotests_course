...
def everything_for_your_cat(cats_data):
    """
    функция принимает на cats_data, группирует данные о кошках по имени и фамилии покупателя,
    и возвращает строку out_str
    :param cats_data: list, состоящий из кортежежей формата
    (кличка_котика, возвраст_котика, имя_покупателя, фамилия_покупателя)
