...
def letter_stat(our_str):
    """
    функция считает кол-во вхождений каждой буквы в строке,
    принимает в качеcтве аргумента строку our_str и возращает словарь letters_dict
    :param our_str: str
    :return letters_dict: dict, ключи - это буквы строки our_str, значение - кол-во вхождений буквы в строку our_str
    """
    letters_dict = {}
    for letter in our_str:
        """
        методом count(i) считаем кол-во входжений символа i в строку our_str
        результат заносим в словарь с ключом i
        """
